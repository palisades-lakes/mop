...
(defn ^TriangleMesh s2--icosahedron []
    (let [r3  (r3-icosahedron)
          s2 (update-vals (.embedding r3) #(s2/point %))]
      (TriangleMesh. (.cmplx r3) s2)))
...
(let [dx (double 0.1)
  ...
  (defn ^TriangleMesh txt-cut-icosahedron []
    (let [a (cmplx/simplex)
          ...
          k (cmplx/simplex)
          l (cmplx/simplex) m (cmplx/simplex) n (cmplx/simplex) o (cmplx/simplex)
          p (cmplx/simplex) q (cmplx/simplex) r (cmplx/simplex) s (cmplx/simplex) t (cmplx/simplex)
          u (cmplx/simplex) v (cmplx/simplex) w (cmplx/simplex) x (cmplx/simplex)
...
(let [da (double (* Math/PI 0.2))
  ...
  (defn ^TriangleMesh s2-cut-icosahedron []
    (let [a (cmplx/simplex)
          b (cmplx/simplex) c (cmplx/simplex) d (cmplx/simplex)
          e (cmplx/simplex) f (cmplx/simplex) g (cmplx/simplex)
          h (cmplx/simplex) i (cmplx/simplex) j (cmplx/simplex)
          k (cmplx/simplex) l (cmplx/simplex) m (cmplx/simplex)
          n (cmplx/simplex)
          s2-embedding {a Point2S/PLUS_K

                        b (Point2S/of (*  0 da) p1)
                        c (Point2S/of (*  2 da) p1)
                        d (Point2S/of (*  4 da) p1)
                        e (Point2S/of (*  6 da) p1)
                        f (Point2S/of (*  8 da) p1)
                        g (Point2S/of (* 10 da) p1)

                        h (Point2S/of (*  -1 da) p2)
                        i (Point2S/of (*  1 da) p2)
                        j (Point2S/of (*  3 da) p2)
                        k (Point2S/of (*  5 da) p2)
                        l (Point2S/of (*  7 da) p2)
                        m (Point2S/of (*  9 da) p2)
